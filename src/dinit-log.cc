...
{
    do_log_cons(loglevel_t::NOTICE, "[  \x1B[0;32mOK\x1B[0m  ] ", service_name, "\n");
...
void log_service_failed(const char *service_name, bool dep_failed) noexcept
{
    ...
    do_log_cons(cons_lvl, "[\x1B[0;31mFAILED\x1B[0m] ", service_name, "\n");
...
{
    do_log_cons(loglevel_t::NOTICE, "[\x1B[0;33mSTOPPD\x1B[0m] ", service_name, "\n");
